...
import static com.pokewords.framework.engine.asm.ProgressBarLoadingState.SpriteName.*;

/**
 * The built-in loading state
 * @author johnny850807 (waterball)
 */
public class ProgressBarLoadingState extends AppState {
